...
import com.ivangarzab.kluvs.api.models.ServerGet200ResponseOneOfClubsInnerAllOfLatestSessionDto
...
data class ServerGet200ResponseOneOfClubsInnerDto (
    ...
    @SerialName(value = "join_policy") @Required val joinPolicy: ServerGet200ResponseOneOfClubsInnerDto.JoinPolicy = JoinPolicy.PRIVATE,
    ...
    @SerialName(value = "latest_session") val latestSession: ServerGet200ResponseOneOfClubsInnerAllOfLatestSessionDto? = null
